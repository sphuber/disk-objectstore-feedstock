...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/disk-objectstore-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11329&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/disk-objectstore-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `disk-objectstore` can be installed with:

```
conda install disk-objectstore
```

It is possible to list all of the versions of `disk-objectstore` available on your platform with:
